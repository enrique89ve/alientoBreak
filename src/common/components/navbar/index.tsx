  ...
  render() {
    ...
    return (
      <div className="sticky-container" id="sticky-container">
        ...
        <div
          className={`nav-bar-sm ${"sticky"} ${step === 1 ? "transparent" : ""
            }`}
        >
          <div className="brand">
            {activeUser !== null ? (
        ...
        {!smVisible && (
          <div
            className={`nav-bar ${!transparentVerify && step === 1 ? "transparent" : ""
              } `}
          >
            <div
                ...
                {!activeUser && (
                  <div>
                    <div className="login-required">
                      ...
                      <Link className="btn btn-primary" to="/signup" target="_black">
                        {_t("g.signup")}
                      </Link>
                    </div>
        ...
        <div
          ref={this.nav}
          className={_c(
            `nav-bar ${!transparentVerify && step === 1 ? "transparent" : ""} ${smVisible ? "visible-sm" : "d-none"
            }`
          )}
        >
