        ...
        <>
              ...
              <img
                src={
                  profile.profile.cover_image
                    ? `https://images.ecency.com/${global.canUseWebp ? "webp/" : ""
                    }u/${username}/cover`
          ...
          <div className="p-3 upper-container">
            <div className="d-flex align-items-center info-container flex-column text-center">
              <div
                className={`rounded-circle mb-3 profile-img-container ${profile && profile.profile.profile_image ? "" : "no-image"
                  }`}
              >
                {loading ? (
                  ...
                  profile && (
                    ...
                    >
                      <img
                        src={`https://images.ecency.com/${global.canUseWebp ? "webp/" : ""
            ...
            <div className="d-flex justify-content-between flex-wrap">
              <div className="flex-grow-1 d-flex border-bottom">
                ...
                <div
                  className={`p-3 flex-grow-1 ${loading
                      ? ""
